  ...
  'case2': '<p>Test 2. Menu of claims and their visualisation options:</p>\
        <table id="myclaimslist">\
          ...
          <tr>\
            ...
            <td class="kind">Marked 1</td>\
            <td><a id="3-marked1" href="#"><img src="images/eye.png" /></a></td>\
          </tr><tr>\
            <td class="kind">Marked 2</td>\
            <td><a id="3-marked2" href="#"><img src="images/eye.png" /></a></td>\
            </tr><tr>\
            <td class="kind">Marked 3</td>\
            <td><a id="3-marked3" href="#"><img src="images/eye.png" /></a></td>\
        </table>',
...
MYDEFAULT = 
  {'all': '<h3>Welcome</h3>',
  'case1': '<h3>Test 1</h3><p></p>',
  'case2': '<h3>Test 2</h3><p></p>',
  'case3': '<h3>Test 3</h3><p></p>'};
...
[
  ...
  {  ////////////////////////////////// TEST 2
    ...
    'raw':'<table><tr><td id="myraw">RAW CLAIM</td><td>\
      ...
      <p></p></td></tr></table>',
    'marked1':'<table><tr><td id="myraw">MARKED CLAIM</td><td>\
      Toolholder, which <span title="This word may cause a problem to define the actual scope of the invention" class="test31 test31_voc5">could</span> <span title="Having at least the following elements/steps" class="test31 test31_voc1">comprise</span> of a holder body with an insert site at its forward end <span title="Some additional elements/steps may be employed without infringement" class="test31 test31_voc2">consisting essentially of</span a bottom surface and at least one side wall where there projects a pin from <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> bottom surface upon which there is located  an insert having a central bore, clamping wedge for wedging engagement between a support surface of the holder and an adjacent edge surface of <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> insert and an actuating screw received in <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> wedge whilst threadably engaged in a bore of <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> holder, <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> support surface and <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> edge surface are at least partially converging downwards <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> wedge clamp having distantly provided protrusions for abutment against the top face and the edge surface of <span title="Refers to a component that is optional" class="test31 test31_voc4">said</span> insert, <span title="Having at least the following elements/steps" class="test31 test31_voc1">characterized</span> in that the wedge <span title="Having all and only the following elements/steps" class="test31 test31_voc3">consists of</span> a pair of distantly provided first protrusions for abutment against a top face of the insert, and a pair of distantly provided second protrusions for abutment against an adjacent edge surface.\
      <p></p></td></tr></table>\
      <p class="legend">Legend:<br /><span class="test31 test31_voc1">Open transition</span>: having at least the following elements/steps.<br />\
      <span class="test31 test31_voc2">Hybrid transition</span>: some additional elements/steps may be employed without infringement.<br />\
      <span class="test31 test31_voc3">Closed transition</span>: having all and only the following elements/steps.<br />\
      <span class="test31 test31_voc4">Claim phrase</span>: refers to a component that is optional.<br />\
      <span class="test31 test31_voc5">Warning</span>: this word may cause a problem to define the actual scope of the invention.</p>',
    'marked2':'<table><tr><td id="myraw">MARKED CLAIM</td><td>\
      Toolholder, which <span title="This word may cause a problem to define the actual scope of the invention" class="test32 test32_voc5">could</span> <span title="Having at least the following elements/steps" class="test32 test32_voc1">comprise</span> of a holder body with an insert site at its forward end <span title="Some additional elements/steps may be employed without infringement" class="test32 test32_voc2">consisting essentially of</span a bottom surface and at least one side wall where there projects a pin from <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> bottom surface upon which there is located  an insert having a central bore, clamping wedge for wedging engagement between a support surface of the holder and an adjacent edge surface of <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> insert and an actuating screw received in <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> wedge whilst threadably engaged in a bore of <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> holder, <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> support surface and <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> edge surface are at least partially converging downwards <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> wedge clamp having distantly provided protrusions for abutment against the top face and the edge surface of <span title="Refers to a component that is optional" class="test32 test32_voc4">said</span> insert, <span title="Having at least the following elements/steps" class="test32 test32_voc1">characterized</span> in that the wedge <span title="Having all and only the following elements/steps" class="test32 test32_voc3">consists of</span> a pair of distantly provided first protrusions for abutment against a top face of the insert, and a pair of distantly provided second protrusions for abutment against an adjacent edge surface.\
      <p></p></td></tr></table>\
      <p class="legend">Legend:<br /><span class="test32 test32_voc1">Open transition</span>: having at least the following elements/steps.<br />\
      <span class="test32 test32_voc2">Hybrid transition</span>: some additional elements/steps may be employed without infringement.<br />\
      <span class="test32 test32_voc3">Closed transition</span>: having all and only the following elements/steps.<br />\
      <span class="test32 test32_voc4">Claim phrase</span>: refers to a component that is optional.<br />\
      <span class="test32 test32_voc5">Warning</span>: this word may cause a problem to define the actual scope of the invention.</p>',
    'marked3':'<table><tr><td id="myraw">MARKED CLAIM</td><td>\
      Toolholder, which <span title="This word may cause a problem to define the actual scope of the invention" class="test33 test33_voc5">could</span> <span title="Having at least the following elements/steps" class="test33 test33_voc1">comprise</span> of a holder body with an insert site at its forward end <span title="Some additional elements/steps may be employed without infringement" class="test33 test33_voc2">consisting essentially of</span a bottom surface and at least one side wall where there projects a pin from <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> bottom surface upon which there is located  an insert having a central bore, clamping wedge for wedging engagement between a support surface of the holder and an adjacent edge surface of <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> insert and an actuating screw received in <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> wedge whilst threadably engaged in a bore of <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> holder, <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> support surface and <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> edge surface are at least partially converging downwards <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> wedge clamp having distantly provided protrusions for abutment against the top face and the edge surface of <span title="Refers to a component that is optional" class="test33 test33_voc4">said</span> insert, <span title="Having at least the following elements/steps" class="test33 test33_voc1">characterized</span> in that the wedge <span title="Having all and only the following elements/steps" class="test33 test33_voc3">consists of</span> a pair of distantly provided first protrusions for abutment against a top face of the insert, and a pair of distantly provided second protrusions for abutment against an adjacent edge surface.\
      <p></p></td></tr></table>\
      <p class="legend">Legend:<br /><span class="test33 test33_voc1">Open transition</span>: having at least the following elements/steps.<br />\
      <span class="test33 test33_voc2">Hybrid transition</span>: some additional elements/steps may be employed without infringement.<br />\
      <span class="test33 test33_voc3">Closed transition</span>: having all and only the following elements/steps.<br />\
      <span class="test33 test33_voc4">Claim phrase</span>: refers to a component that is optional.<br />\
      <span class="test33 test33_voc5">Warning</span>: this word may cause a problem to define the actual scope of the invention.</p>'
  },
  { ////////////////////////////////// TEST 3
